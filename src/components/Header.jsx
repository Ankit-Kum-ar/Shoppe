...
const Header = () => {
    ...
    return (
        <nav className="border-gray-200 bg-black m-3 rounded-3xl">
        <div className="w-full flex flex-wrap items-center justify-between mx-auto md:p-4 p-3">
            <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="/logo.png" className="h-8" alt="Flowbite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">𝓢𝓗𝓞𝓟𝓟𝓔</span>
            </Link>
